...
class _MantenimientoUsuarioViewState extends State<MantenimientoUsuarioView> {
  ...
  Widget build(BuildContext context) {
    // Obtener rol del usuario autenticado desde AuthViewModel
    final authVM = Provider.of<AuthViewModel>(context);
    final currentUserRole = authVM.user?.rol ?? 'invitado';
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final usuarioRole = usuario['rol'] ?? 'invitado';
          return Card(
            child: ListTile(
              title: Text(usuario['username']),
              subtitle: Text('ID: ${usuario['id']} | Rol: $usuarioRole'),
              trailing: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  // Editar: disponible para admin y para el mismo usuario
                  if (currentUserRole == 'admin' || authVM.user?.id == usuario['id'])
                    IconButton(
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) => ActualizarUsuarioView(
                              ...
                              nombre: usuario['nombre'],        // ← agrega este campo
